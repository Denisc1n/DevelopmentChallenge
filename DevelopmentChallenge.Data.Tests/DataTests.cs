    ...
    public class DataTests
    {
        ...
        public void TestResumenListaConMasTipos()
        {
            var formas = new List<FormaGeometrica>
            {
                ...
                new FormaGeometrica(FormaGeometrica.Rectangulo, 4m, 3m),
                new FormaGeometrica(FormaGeometrica.Cuadrado, 2),
                new FormaGeometrica(FormaGeometrica.Trapecio, 6m, 4m, 2m),
        ...
        public void TestResumenListaConRectangulosEnItaliano()
        {
            ...
            {
                new FormaGeometrica(FormaGeometrica.Rectangulo, 4m, 3m),
                new FormaGeometrica(FormaGeometrica.Rectangulo, 2m, 5m)
            };
        ...
        public void TestResumenListaConTrapecioEnIngles()
        {
            var formas = new List<FormaGeometrica>
            {
                new FormaGeometrica(FormaGeometrica.Cuadrado, 2m),
                new FormaGeometrica(FormaGeometrica.Trapecio, 6m, 4m, 2m)
            };
