    ...
    public class DataTests
    {
        ...
        public void TestResumenListaVacia()
        {
            Assert.AreEqual("<h1>Lista vacía de formas!</h1>",
                FormaGeometrica.Imprimir(new List<FormaGeometrica>(), (int)EIdioma.Castellano));
        }
        ...
        public void TestResumenListaVaciaFormasEnIngles()
        {
            Assert.AreEqual("<h1>Empty list of shapes!</h1>",
                FormaGeometrica.Imprimir(new List<FormaGeometrica>(), (int)EIdioma.Ingles));
        }
        ...
        public void TestResumenListaVaciaFormasEnItaliano()
        {
            Assert.AreEqual("<h1>Lista vuota di forme!</h1>",
                FormaGeometrica.Imprimir(new List<FormaGeometrica>(), (int)EIdioma.Italiano));
        }

        [TestCase]
        public void TestResumenListaConUnCuadrado()
        {
            var cuadrados = new List<FormaGeometrica> {new FormaGeometrica((int)EForma.Cuadrado, 5)};

            var resumen = FormaGeometrica.Imprimir(cuadrados, (int)EIdioma.Castellano);
        ...
        public void TestResumenListaConMasCuadrados()
        {
            ...
            {
                new FormaGeometrica((int)EForma.Cuadrado, 5),
                new FormaGeometrica((int)EForma.Cuadrado, 1),
                new FormaGeometrica((int)EForma.Cuadrado, 3)
            };

            var resumen = FormaGeometrica.Imprimir(cuadrados, (int)EIdioma.Ingles);
        ...
        public void TestResumenListaConMasTipos()
        {
            ...
            {
                new FormaGeometrica((int)EForma.Cuadrado, 5),
                new FormaGeometrica((int)EForma.Circulo, 3),
                new FormaGeometrica((int)EForma.TrianguloEquilatero, 4),
                new FormaGeometrica((int)EForma.Rectangulo, 4m, 3m),
                new FormaGeometrica((int)EForma.Cuadrado, 2),
                new FormaGeometrica((int)EForma.Trapecio, 6m, 4m, 2m),
                new FormaGeometrica((int)EForma.TrianguloEquilatero, 9),
                new FormaGeometrica((int)EForma.Circulo, 2.75m),
                new FormaGeometrica((int)EForma.TrianguloEquilatero, 4.2m)
            };

            var resumen = FormaGeometrica.Imprimir(formas, (int)EIdioma.Ingles);
        ...
        public void TestResumenListaConMasTiposEnCastellano()
        {
            ...
            var resumen = FormaGeometrica.Imprimir(formas, (int)EIdioma.Castellano);
        ...
        public void TestResumenListaConMasTiposEnItaliano()
        {
            ...
            var resumen = FormaGeometrica.Imprimir(formas, (int)EIdioma.Italiano);
        ...
        public void TestResumenListaConRectangulosEnItaliano()
        {
            ...
            {
                new FormaGeometrica((int)EForma.Rectangulo, 4m, 3m),
                new FormaGeometrica((int)EForma.Rectangulo, 2m, 5m)
            };
        ...
        public void TestResumenListaConTrapecioEnIngles()
        {
            var formas = new List<FormaGeometrica>
            {
                new FormaGeometrica((int)EForma.Cuadrado, 2m),
                new FormaGeometrica((int)EForma.Trapecio, 6m, 4m, 2m)
            };
